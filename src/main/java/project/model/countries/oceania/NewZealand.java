...
/**
 * This class defines the country values corresponding to new zealand
 * @author kolkol, Johan
 */
...
public class NewZealand extends Country {
     ...
     */
    public NewZealand() {
        String[] easyAnswers = {"NewZealand","Nya Zeeland","New Zealand","New Zeeland","NyaZeeland"};
        String[] mediumAnswers = {"NewZealand","Nya Zeeland","New Zealand","New Zeeland","NyaZeeland"};
        String[] hardAnswers = {"Nya Zeeland","NyaZeeland"};

        int countryColorIndex = 163;
